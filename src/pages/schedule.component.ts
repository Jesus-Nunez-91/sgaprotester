...
@Component({
    ...
    <div class="max-w-7xl mx-auto py-8 animate-fadeIn pb-20">
      ...
      <!-- The Schedule Grid -->
      <div class="glass-panel bg-white/80 dark:bg-gray-900/80 rounded-3xl shadow-2xl overflow-hidden border border-white/50 dark:border-gray-700 relative text-black dark:text-white" role="grid" [attr.aria-label]="'Cuadrícula de Horarios de ' + selectedLab()">
              ...
              <div class="min-w-[1000px] p-4 md:p-6">
                  ...
                  <div class="grid grid-cols-6 gap-4 mb-4" role="row">
                      ...
                      @for (day of days; track day) {
                          <div class="text-center" role="columnheader">
                  ...
                  <div class="space-y-4">
                      @for (block of timeBlocks; track block) {
                          <div class="grid grid-cols-6 gap-4 group" role="row">
                              <!-- Time Column -->
