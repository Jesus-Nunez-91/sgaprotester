...
@Component({
   ...
   template: `
    <div class="animate-fadeIn pb-10">
      ...
      <div class="mb-8">
         <div class="glass-panel bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-3xl shadow-lg border border-white/50 dark:border-gray-700 overflow-hidden flex flex-col h-[300px]">
            ...
            <div class="flex-1 overflow-y-auto p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 custom-scrollbar">
